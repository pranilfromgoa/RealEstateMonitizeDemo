...
import { AdminPlatformSecurity } from '@/pages/admin/PlatformSecurity'
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/admin/security" element={<ProtectedRoute role="admin"><AdminPlatformSecurity /></ProtectedRoute>} />
